...
function Guia() {
  return (
    <div style={{maxWidth:700, margin:'110px auto 60px auto', background:'#2f3d2b', border:'2.5px solid #bfa14a', borderRadius:16, boxShadow:'0 2px 16px #0002', color:'#fff', padding:32, width:'100%', boxSizing:'border-box',
  ...
  <h2 style={{color:'#e6c86b', fontWeight:700, fontSize:28, marginBottom:18, textAlign:'center'}}>Guía para Publicar un Aviso</h2>
  <ol style={{fontSize:18, marginBottom:28, paddingLeft:24, color:'#fff', textAlign:'left'}}>
        ...
        <li>Inicia sesión con tu cuenta, si no tienes regístrate.</li>
      ...
      <div style={{fontSize:18, marginTop:24, background:'#fff2', color:'#ffffffff', borderRadius:10, padding:18, textAlign:'center'}}>
        ...
        Escribe a: <a href="mailto:ventadearmasargentina@gmail.com" style={{color:'#e6c86b', fontWeight:700}}>ventadearmasargentina@gmail.com</a>
      </div>
    </div>
  );
}
